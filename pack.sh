...
/Applications/Visual\ Studio\ \(Preview\).app/Contents/MacOS/vstool setup pack /Users/ivokrugers/Xamarin_Projects/VisualStudioMac.SolutionTreeFilter/VisualStudioMac.SolutionTreeFilter/bin/VisualStudioMac.SolutionTreeFilter.dll 


# Copy to local dir
for filename in /Applications/Visual\ Studio\ \(Preview\).app/*SolutionTreeFilter*.mpack;
do
  echo "move $filename"
  mv "$filename" .
done
